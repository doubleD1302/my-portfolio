        ...
        <div class="contact-grid">
          ...
          <div class="contact-info-card">
            ...
            <p style="color: var(--color-text-secondary); line-height: 1.7; margin-bottom: 1.5rem;">
              I am open to Full-stack Developer Intern opportunities, Software Engineering roles, or collaborative practical projects.
            </p>
            ...
            <div class="contact-direct-item">
              ...
              <div>
                <div style="font-size: 0.82rem; color: var(--color-text-muted); text-transform: uppercase; font-weight: 600;">Phone / Zalo</div>
                <a href="tel:0354001205" style="font-weight: 600; color: var(--color-text-primary);">0354 001 205</a>
              </div>
            </div>
